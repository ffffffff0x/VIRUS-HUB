...
//创建sustes文件夹，下载wc.conf文件，检验sustes。开始下载挖矿木马了，黑客事先已经将木马文件上传到一些网站，通过脚本将木马下载到特定目录下并修改文件名，添加执行权限并启动
...
检验md5后从192.99.142.226:8220下载64位文件
